class DirectorsController < ApplicationController
  ...
  def show
    ...
    @proyects = Proyect.select("id, name").where(:director_id => params[:id]);
  end
...
@proyects = Proyect.where(director: @director.id)
@proyects.each do |director|
  proyect.destroy
end
@director.destroy
  ...
  private
    ...
    def director_params
      params.require(:director).permit(:name, :contact, :email)
    end
end
