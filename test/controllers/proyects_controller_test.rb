...
class ProyectsControllerTest < ActionController::TestCase
  ...
  test "should create proyect" do
    assert_difference('Proyect.count') do
      post :create, proyect: { client: @proyect.client, director: @proyect.director, name: @proyect.name, proyect_type: @proyect.proyect_type }
    end
  ...
  test "should update proyect" do
    patch :update, id: @proyect, proyect: { client: @proyect.client, director: @proyect.director, name: @proyect.name, proyect_type: @proyect.proyect_type }
    assert_redirected_to proyect_path(assigns(:proyect))
  end
